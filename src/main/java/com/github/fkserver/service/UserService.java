package com.github.fkserver.service;
...
import com.github.fkserver.builder.UserBuilder;
...
import com.github.fkserver.repository.AuthorityRepository;
...
import com.github.fkserver.utils.RandomUtil;
...
public class UserService {
    ...
    public void changePassword(String currentClearTextPassword, String newPassword) {
        SecurityUtils.getCurrentUserLogin().flatMap(userRepository::findOneByLogin).ifPresent(user -> {
            ...
            if (!passwordEncoder.matches(currentClearTextPassword, currentEncryptedPassword)) {
                throw new BizException("Invalid password: " + currentEncryptedPassword);
            }
    ...
    public Page<AdminUserDTO> getAllManagedUsers(Pageable pageable) {
        return userRepository.findAll(pageable).map(AdminUserBuilder::build);
    }

    @Transactional(readOnly = true)
    public Page<UserDTO> getAllPublicUsers(Pageable pageable) {
        return userRepository.findAllByIdNotNullAndActivatedIsTrue(pageable).map(UserBuilder::build);
    }
